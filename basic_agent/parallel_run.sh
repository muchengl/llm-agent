...
ENV_VARIABLES="export SHOPPING='http://${WEBARENA_HOST}:7770';export SHOPPING_ADMIN='http://${WEBARENA_HOST}:7780/admin';export REDDIT='http://${WEBARENA_HOST}:9999';export GITLAB='http://${WEBARENA_HOST}:8023';export MAP='http://miniserver1875.asuscomm.com:3000';export WIKIPEDIA='http://${WEBARENA_HOST}:8888/wikipedia_en_all_maxi_2022-05/A/User:The_other_Kiwix_guy/Landing';export HOMEPAGE='http://${WEBARENA_HOST}:4399';export OPENAI_API_KEY=${OPENAI_API_KEY};export OPENAI_ORGANIZATION=${OPENAI_ORGANIZATION}"
